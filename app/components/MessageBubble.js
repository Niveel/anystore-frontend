...
const MessageBubble = ({msgPress, justifyContent, index, msgId, selectedMessageIds, msgContent, isCurrentUser, msgSenderUsername, msgTime, selectedMessages, msgIsInFlaggedMessages, messageLongPress, selectMessage, doubleTapMessage, msgSentiment, ...otherProps}) => {
